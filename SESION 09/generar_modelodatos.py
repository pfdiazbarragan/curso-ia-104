...
def generar_tablahechos(mes):
    ...
    nombre_archivo_directorio = os.path.join("SESION 09")
    ...
    nombre_archivo_origen = os.path.join("SESION 09","DATOS_ABIERTOS_LICENCIAS.csv")
    ...
    dimensiones_nombres = [
        "TIPO_RESOLUCION", "RIESGODDCC", "TIPINSP", "RESULTADO_ITSE", "ESTADO_VIGENCIA", "DEPARTAMENTO", 
